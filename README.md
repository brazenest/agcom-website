...
This project is released under the __[GNU Affero General Public License, Version 3](https://www.gnu.org/licenses/agpl-3.0.en.html#license-text)__ license.

A copy of this license is provided within this project [here](LICENSE.md).

### License Summary

_NOTE: This summary is **NOT a substitute** for the license text itself._

This is a free software license that guarantees end users the freedom to run, study, share, and modify the software. Key points include:
