    ...
    <section id="contact" className="max-w-6xl mx-auto px-6 py-12">
      <div className="rounded-2xl p-8 bg-[var(--color-surface)] border border-[var(--color-divider)] text-center">
        ...
        <div className="flex items-center justify-center">
          <ContactFormModal id="home-contact" buttonText="Get in touch" buttonClassName="inline-flex items-center px-6 py-3 rounded-lg bg-gradient-to-r from-[var(--color-accent-blue)] to-[var(--color-accent-amber)] text-white font-[var(--font-engineering)] !text-black" />
        </div>
      </div>
    </section>
  );
