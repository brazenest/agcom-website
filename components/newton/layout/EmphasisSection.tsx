...
export const EmphasisSection = ({
	...
	return (
		<section id={id} className="emphasis-section py-12 lg:py-24 md:px-6 bg-blue-100 dark:bg-blue-900 border border-blue-200 dark:border-blue-800 text-center max-w-4xl lg:max-w-5xl mx-auto">
