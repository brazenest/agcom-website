...
export const EmphasisSection = ({
	...
	return (
		<section id={id} className="emphasis-section py-12 lg:py-24 px-6 bg-gray-200 dark:bg-gray-800 border border-gray-300 text-center max-w-4xl lg:max-w-5xl mx-auto">
