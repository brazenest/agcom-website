...
export const EmphasisSection = ({
	...
	return (
		<section id={id} className="emphasis-section py-9.75 md:py-13 px-5 md:px-9.25 lg:px-8 bg-blue-50 dark:bg-blue-900 md:rounded-lg border-2 border-blue-300 dark:border-blue-800 text-center max-w-4xl lg:max-w-7xl mx-auto">
