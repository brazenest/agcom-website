...
export const PageTitle = ({ align = 'center', title, subtitle, subtitleClassName, className }: PageTitleProps) => {
	...
	return (
		<span className={cn("page-title-wrap pb-3 block", className)}>
			<h1 className={cn('page-title max-w-3xl lg:max-w-5xl text-4xl md:text-5xl lg:text-6xl md:leading-13.75 font-heading font-semibold text-shadow-md lg:leading-19', alignClasses[align].title)}>{title}</h1>
			{subtitle && (
