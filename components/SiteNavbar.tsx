  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-[rgba(14,14,16,0.8)] border-b border-[var(--color-divider)]">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="flex gap-6 text-sm font-[var(--font-engineering)] text-[var(--color-text-primary)]">
          ...
          <Link href="#contact" className="hover:text-[var(--color-accent-amber)] transition-colors">
            Contact
          </Link>
        </div>
      </div>
