	...
	return (
		<Page id="home-page">
			...
			<Section id="split-intro">
				<SectionHeading
					title="Dual disciplines, two lenses, one creator."
					subtitle="Bridging software engineering and video production to craft seamless digital experiences."
				/>
				<div
			...
			<Section id="approach-overview">
				<SectionHeading
					...
					subtitle="Integrating robust engineering with cinematic storytelling to deliver engaging digital experiences."
				/>
			...
			<Section id="selected-projects">
				<SectionHeading
					...
					subtitle="A curated selection of my work that highlights the intersection of robust engineering and cinematic storytelling."
				/>
