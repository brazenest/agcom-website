...
export default function HomePage() {
  return (
    <div className="font-sans">
      <main className="flex flex-col mx-auto max-w-5xl py-10 px-4">
        ...
        <p className="text-lg my-3"><strong>Hello! I&apos;m Alden Gillespy, a solid software engineer, a world-notable video producer, and a keen photographer</strong> with years of experience in back-end API development, full-stack web development stacks (e.g. React, Node, PHP), and a bevvy of related tools; and intense experience in videography, video editing, and photography, of a variety of subjects and scenes in magnificent settings.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          {/* Software Engineer Card */}
          <div className="rounded-lg shadow-md dark:shadow-0 p-6">
          ...
          {/* Contact Card */}
          <div className="bg-gray-900 dark:bg-gray-100 text-white rounded-lg shadow-md dark:shadow-0 p-6">
            <h2 className="text-2xl font-bold dark:text-gray-900 mb-4 text-center">Contact Me</h2>
            <div className="mb-4 flex justify-center">
              <Image
