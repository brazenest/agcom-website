export const PageBanner = ({ title, pText, children }: PageBannerProps) => (
    <section className="relative flex flex-col items-center justify-center text-center p-12 sm:p-9 lg:p-13 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 text-white">
